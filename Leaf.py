...
"}")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_2.setText(_translate("MainWindow", "Leaf Disease Detection"))
    ...
    def upload_image(self):
        ...
        path=str(path)
        print(path)
        model=load_model('C:/Users/abhishek kumar/OneDrive/Desktop/archive/chest_xray/potatoes.h5') 
        img_file=load_img(path,target_size=(256,256,3))
    ...
    def predict_result(self):
        ...
        if result[0][0]>0.5:
            ...
            speak("Leaf is Healthy")
        else:
            print("Leaf is Unhealthy")
            speak("Leaf is Unhealthy")
